...
#### 3. Mudar o dono do ficheiro /var/lib/ldap/DB_CONFIG para ser do utilizador ldap:
...
#### 7. Usar o output desse comando para criar o ficheiro chanceBDpw.ldif com o seguinte input:
...
#### 7. Executar para  adicionar a configuração do ficheiro acima:
...
#### 8. Criar file configBDLDAP.ldif contendo:
...
#### 8. Modificar a configuração:

	# ldapmodify -Y EXTERNAL -H ldapi:/// -f configBDLDAP.ldif  

#### 8. Listar a configuração que tem até agora (usando a password que criou para acesso ao LDAP (a primeira)):
...
#### 9. Criar o ficheiro userAccess.ldif contendo:
...
#### 9. Verificar o controlo de acesso criado no último ponto listando os mesmos com:
...
#### 9. Ver todas as estruturas que têm controlo de acesso definido, com o acesso e o sufixo:
