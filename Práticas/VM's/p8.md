...
4
### Recriar a conta LDAP do aauser que se apagou acima (pode fazê-lo do server ou do Desktop). Fazer a busca no Desktop para saber o uidNumber do aauser no LDAP:
